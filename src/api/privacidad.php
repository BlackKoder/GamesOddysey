...
<body class="light-theme">
  ...
  <main class="main-article"> 
        ...
        <article class="articulo-cookies">
            ...
            <p>La presente Política de Privacidad establece los términos en que Games Oddysey
            ...
            seguridad de los datos de sus usuarios. Sin embargo, esta Política de Privacidad puede cambiar con el
            ...
            <h2 class="subtitulo">Información que es recogida</h2>
            <p>
            ...
            demográfica.</p>
                ...
                <h2 class="subtitulo">Uso de la información recogida</h2>

                <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor
                servicio posible, particularmente para mantener un registro de usuarios, y mejorar nuestros artículos y servicios.  Es
                posible que sean enviados correos electrónicos periódicamente a través de
                nuestro sitio con ofertas especiales, nuevos artículos y otra información
                ...
                proporcione y podrán ser cancelados en cualquier momento. <br><br>
                Games Oddysey está altamente comprometido para cumplir con el
                compromiso de mantener su información segura. Usamos los sistemas más
                avanzados y los actualizamos constantemente para asegurarnos que no exista
                ningún acceso no autorizado.</p>

                <h2 class="subtitulo">COOKIES</h2>
                ...
                también facilita las futuras visitas a una web recurrente. <br><br> Otra función que tienen
                ...
                de que usted así lo quiera y la proporcione directamente, visitas a una web. <br><br>
                ...
                <h2 class="subtitulo">Enlaces a Terceros</h2>

                <p>Este sitio web pudiera contener enlaces a otros sitios que pudieran ser de su
                interés. Una vez que usted dé click en estos enlaces y abandone nuestra
                ...
                <h2 class="subtitulo">Control de su información personal</h2>
                ...
                cancelarla en cualquier momento. <br><br>
                Esta pagina no venderá, cederá ni distribuirá la información personal que es
                recopilada sin su consentimiento, salvo que sea requerido por un juez con un
                orden judicial. <br><br>
                Games Oddysey Se reserva el derecho de cambiar los términos de la
